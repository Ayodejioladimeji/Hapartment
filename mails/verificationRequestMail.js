...
// send register mail
const verificationRequestMail = (to, fullname) => {
          ...
          <main>
            ...
            <p class="body">
              <span style="color: green; font-weight: bold"
                >Thank you for joining us, we have receive your request for verification.</span
              >
            </p>
  
            <p class="body">
              We will review your submission and get back to you as soon as
              possible
            </p>
...
module.exports = verificationRequestMail;
