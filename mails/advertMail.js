    ...
    <section>
      <div class="container" style="background: #f8f9fc;">
        ...
        <main>
          ...
          <p class="body">
            Thank you for your interest in placing your product banner on
            Hapartment Digital Marketplace.
          </p>

          <p class="body">
            Your banner will be displayed on our platform for two months, with
            no extra cost, after which you will renew at the end of two months.
          </p>

          <p class="body">
            Check out our pricing plan below, and find the required information
            for renewal after the first two months.
            <br />
            1 Month - ₦2,000
            <br />
          ...
          <p class="body">
            Our team is currently reviewing your request and we will get back to
            you as soon as possible.
            <br />
          </p>

          <p class="body">
            Thank you for contacting us, we appreciate your business and look
