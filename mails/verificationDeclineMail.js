...
// send register mail
const verificationDeclineMail = (to, fullname, one, two, three) => {
      ...
      <section>
        <div class="container">
          ...
          <main>
            ...
            <p class="body">
              We have reviewed your submissions and regret to inform you that your
...
module.exports = verificationDeclineMail;
