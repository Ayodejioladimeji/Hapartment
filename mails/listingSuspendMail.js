...
// send register mail
const listingSuspendedMail = (to, fullname) => {
      ...
      <section>
        <div class="container" style="background: #f8f9fc;">
          ...
          <main>
            ...
            <p class="body">
              We regret to inform you that your property has been suspended due to
              consequent report on the property.
            </p>
  
            <p class="body">
              To reactivate your property, please reach out to our customer support
              team at [support@hapartment.org]. Our team will be happy to assist
              you in resolving the issue and getting your property back up and
...
module.exports = listingSuspendedMail;
